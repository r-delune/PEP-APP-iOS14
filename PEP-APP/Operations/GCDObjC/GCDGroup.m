...
//@property (readwrite, strong, nonatomic) __attribute__((NSObject)) dispatch_queue_t dispatchGroup;
//@property (readwrite, strong, nonatomic) __attribute__((NSObject)) dispatch_group_t dispatchGroup;
